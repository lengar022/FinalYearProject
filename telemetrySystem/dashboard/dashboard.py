...
def main():
    ...
    while running:
        ...
        if fuel_pct is not None and fuel_pct < 20:
            fuel_pct_color = (255, 0, 0) 
        else:
            fuel_pct_color = (255, 255, 255) 
            
        screen.blit(font_med.render(fuel_txt, True, fuel_pct_color), (int(w*0.55), int(h*0.08)))
